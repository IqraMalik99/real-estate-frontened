      ...
      <div className="p-6 bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-lg rounded-xl border border-white/30 shadow-lg min-h-[500px] w-5/6 mx-auto lg:w-1/3 flex flex-col items-center mt-4">
        ...
        <form onSubmit={handleSubmit(Submit)} className="w-full flex flex-col items-center mt-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between w-full max-w-72 mt-2 gap-2">
            ...
            <Link
              to="/delete"
              className="flex items-center justify-center px-4 py-2 bg-red-600 text-white font-bold rounded-lg shadow-md hover:bg-red-700 transition duration-300 ease-in-out transform hover:-translate-y-1"
            >
              <Trash2 className="w-5 h-5 mr-2" />
              Delete account
            </Link>
